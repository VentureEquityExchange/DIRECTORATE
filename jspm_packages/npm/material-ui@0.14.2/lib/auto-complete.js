...
var AutoComplete = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement('div', {
    ...
    }, _react2.default.createElement('div', {style: {width: '100%'}}, _react2.default.createElement(_textField2.default, _extends({}, other, {
      ref: 'searchTextField',
      ...
      onBlur: function onBlur() {
        if (_this2.focusOnInput && open)
          _this2.refs.searchTextField.focus();
      },
      onFocus: function onFocus() {
        if (!open && (_this2.props.triggerUpdateOnFocus || _this2.props.updateWhenFocused || _this2.requestsList > 0)) {
