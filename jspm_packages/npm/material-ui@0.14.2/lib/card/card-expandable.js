...
var CardExpandable = _react2.default.createClass({
  ...
  getStyles: function getStyles() {
    ...
    return {root: (0, _extend2.default)({
        top: 0,
        bottom: 0,
        margin: 'auto',
        position: 'absolute'
  ...
  render: function render() {
    ...
    if (this.props.expanded === true)
      expandable = _react2.default.createElement(_keyboardArrowUp2.default, null);
    else
      expandable = _react2.default.createElement(_keyboardArrowDown2.default, null);
