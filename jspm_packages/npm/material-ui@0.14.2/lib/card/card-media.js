...
var _styles = require('../styles/index');
  ...
  render: function render() {
    ...
    var overlayChildren = _react2.default.Children.map(this.props.overlay, function(child) {
      if (child.type.displayName === 'CardHeader' || child.type.displayName === 'CardTitle') {
        ...
        return _react2.default.cloneElement(child, {color: _styles2.default.Colors.darkWhite});
      } else {
        return child;
      }
    });
    return _react2.default.createElement('div', _extends({}, this.props, {style: rootStyle}), _react2.default.createElement('div', {style: mediaStyle}, children), this.props.overlay ? _react2.default.createElement('div', {style: overlayContainerStyle}, _react2.default.createElement('div', {style: overlayStyle}, _react2.default.createElement('div', {style: overlayContentStyle}, overlayChildren))) : '');
  }
});
