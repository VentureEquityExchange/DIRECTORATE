...
(function(process) {
  ...
  var DropDownIcon = _react2.default.createClass({
    ...
    render: function render() {
      ...
      return _react2.default.createElement('div', _extends({}, other, {style: this.prepareStyles(styles.root, style)}), _react2.default.createElement('div', {onTouchTap: this._onControlClick}, _react2.default.createElement(_fontIcon2.default, {
        className: iconClassName,
        style: iconStyle
      }, iconLigature), children), _react2.default.createElement(_menu2.default, {
        ref: 'menuItems',
        style: styles.menu,
        menuItems: menuItems,
