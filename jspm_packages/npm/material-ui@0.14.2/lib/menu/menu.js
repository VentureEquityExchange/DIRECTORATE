...
(function(process) {
  ...
  var NestedMenuItem = _react2.default.createClass({
    ...
    render: function render() {
      ...
      }, _react2.default.createElement(_menuItem3.default, {
        index: index,
        style: menuItemStyle,
      ...
      }, this.props.text), _react2.default.createElement(Menu, _extends({}, other, {
        ref: 'nestedMenu',
      ...
      for (var i = 0; i < this.props.menuItems.length; i++) {
        ...
        switch (menuItem.type) {
          ...
          case _menuItem3.default.Types.NESTED:
            ...
            break;
          default:
            itemComponent = _react2.default.createElement(_menuItem3.default, _extends({}, other, {
    ...
    _collapseHideableMenu: function _collapseHideableMenu() {
      ...
      this._nextAnimationFrame(function() {
        ...
        if (originalOpacity === '')
          ...
          _cssEvent2.default.onTransitionEnd(el, end);
      });
    },
