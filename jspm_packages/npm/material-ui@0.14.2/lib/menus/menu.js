...
var Menu = _react2.default.createClass({
  ...
  _getSelectedIndex: function _getSelectedIndex(props, filteredChildren) {
    ...
    filteredChildren.forEach(function(child) {
      var childIsADivider = child.type && child.type.displayName === 'Divider';
      if (_this3._isChildSelected(child, props))
  ...
  render: function render() {
    ...
    var styles = {
      ...
      selectedMenuItem: {color: rawTheme.palette.accent1Color}
    };
    ...
    var newChildren = _react2.default.Children.map(filteredChildren, function(child) {
      ...
      if (animated) {
        ...
        childrenContainerStyles = _this4.prepareStyles(styles.menuItemContainer, {transitionDelay: transitionDelay + 'ms'});
      }
      ...
      if (!childIsADivider && !childIsDisabled)
        menuItemIndex++;
      return animated ? _react2.default.createElement('div', {style: childrenContainerStyles}, clonedChild) : clonedChild;
    });
