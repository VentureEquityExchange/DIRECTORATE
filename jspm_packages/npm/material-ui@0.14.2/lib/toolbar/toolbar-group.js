  ...
  getStyles: function getStyles() {
    ...
    var styles = {
      ...
      icon: {
        ...
        hover: {color: _colors2.default.darkBlack}
      },
      span: {
        float: 'left',
        color: this.getTheme().iconColor,
  ...
  render: function render() {
    ...
    var newChildren = _react2.default.Children.map(children, function(currentChild) {
      ...
      switch (currentChild.type.displayName) {
        ...
        case 'RaisedButton':
        case 'FlatButton':
          return _react2.default.cloneElement(currentChild, {style: _this.mergeStyles(styles.button, currentChild.props.style)});
        case 'FontIcon':
          return _react2.default.cloneElement(currentChild, {
        ...
        case 'ToolbarTitle':
          return _react2.default.cloneElement(currentChild, {style: _this.mergeStyles(styles.span, currentChild.props.style)});
        default:
          return currentChild;
      }
    }, this);
